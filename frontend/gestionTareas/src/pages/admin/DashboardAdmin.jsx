      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Administrators</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Teachers</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Students</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Observers</h2>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        ...
                        ${user.role === 'ESTUDIANTE' ? 'bg-indigo-100 text-indigo-800' : ''}
                        ${user.role === 'OBSERVADOR' ? 'bg-amber-100 text-amber-800' : ''}
                      `}>
                        {user.role === 'ADMINISTRADOR' ? 'Admin' : ''}
                        {user.role === 'DOCENTE' ? 'Teacher' : ''}
                        {user.role === 'ESTUDIANTE' ? 'Student' : ''}
                        {user.role === 'OBSERVADOR' ? 'Observer' : ''}
                      </span>
                    </div>
                  </div>
                </li>
